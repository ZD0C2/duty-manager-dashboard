-- Fix InnRelay Stays onboarding so the property, owner membership, teams,
-- areas and routes are created atomically under the caller's RLS context.
...
begin
  ...
  -- Bootstrap the owner before inserting manager-protected configuration.
